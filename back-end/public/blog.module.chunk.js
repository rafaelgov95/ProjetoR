...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__posts_posts_component__ = __webpack_require__("../../../../../src/app/blog/posts/posts.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__blog_component__ = __webpack_require__("../../../../../src/app/blog/blog.component.ts");
...
var routes = [
    ...
    { path: 'post/:id', component: __WEBPACK_IMPORTED_MODULE_0__posts_posts_component__["a" /* PostsComponent */] }
];
...
var BlogComponent = (function () {
    ...
    BlogComponent.prototype.Editar = function (post) {
    ...
    BlogComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.inscricao = this.servicePost.getAll().subscribe(function (data) { return _this.Posts = data; }, function (erro) { return console.log('Erro'); });
        this.servicePost.emitterDelivery.subscribe(function (post) {
            var pos = _this.Posts.indexOf(_this.Posts.find(function (item) { return item._id === post._id; }));
            console.log(pos);
            if (pos > -1) {
                console.log("Esse cara ja existe vamos atualizar");
                // this.Posts.splice(pos,1)
                _this.Posts[pos] = post;
            }
            else {
    ...
    BlogComponent.prototype.Remove = function (post) {
        var _this = this;
        this.servicePost.remove(post)
            .subscribe(function (data) { _this.Posts.splice(_this.Posts.indexOf(post), 1), console.log(post); }, function (err) { return console.log(err); });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__htmleditor_htmleditor_component__ = __webpack_require__("../../../../../src/app/blog/htmleditor/htmleditor.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_angular_froala_wysiwyg__ = __webpack_require__("../../../../angular-froala-wysiwyg/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shared_services_alert_service__ = __webpack_require__("../../../../../src/app/shared/services/alert.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__shared_services_posts_ServicePost__ = __webpack_require__("../../../../../src/app/shared/services/posts/ServicePost.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
BlogModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["M" /* NgModule */])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_1_angular_froala_wysiwyg__["a" /* FroalaEditorModule */].forRoot(), __WEBPACK_IMPORTED_MODULE_1_angular_froala_wysiwyg__["b" /* FroalaViewModule */].forRoot()
        ],
        declarations: [__WEBPACK_IMPORTED_MODULE_7__blog_component__["a" /* BlogComponent */], __WEBPACK_IMPORTED_MODULE_5__posts_posts_component__["a" /* PostsComponent */], __WEBPACK_IMPORTED_MODULE_0__htmleditor_htmleditor_component__["a" /* HtmleditorComponent */]],
        providers: [__WEBPACK_IMPORTED_MODULE_9__shared_services_posts_ServicePost__["a" /* ServicePost */], __WEBPACK_IMPORTED_MODULE_8__shared_services_alert_service__["a" /* AlertService */]],
        exports: [__WEBPACK_IMPORTED_MODULE_7__blog_component__["a" /* BlogComponent */], __WEBPACK_IMPORTED_MODULE_0__htmleditor_htmleditor_component__["a" /* HtmleditorComponent */]]
    })
], BlogModule);
...
var HtmleditorComponent = (function () {
    function HtmleditorComponent(fb, servicePost) {
        this.fb = fb;
        this.servicePost = servicePost;
        this.esconder = false;
        this.editar = false;
        this.AvisaPai = new __WEBPACK_IMPORTED_MODULE_2__angular_core__["x" /* EventEmitter */]();
        this.formErrors = {
            'titulo': '',
            'resumo': '',
            'texto': ''
        ...
        this.post = new __WEBPACK_IMPORTED_MODULE_1__shared_models_post__["a" /* Post */]('', '', '', this.autor, new Date());
    }
    HtmleditorComponent.prototype.ngOnChanges = function (event) {
    ...
    HtmleditorComponent.prototype.cancelar = function () {
        this.editar = false;
        this.post = new __WEBPACK_IMPORTED_MODULE_1__shared_models_post__["a" /* Post */]('', '', '', this.autor, new Date());
        this.HtmlEditor.reset();
        this.buildForm();
    ...
    HtmleditorComponent.prototype.onSubmit = function (post) {
        var _this = this;
        if (this.editar) {
            post._id = this.post._id;
            this.servicePost.updatePost(post).subscribe(function (data) {
                _this.servicePost.emitterDelivery.emit(post);
            }, function (err) { return console.log("Erro"); });
        }
        else {
            this.servicePost.create(post).subscribe(function (data) {
                return _this.servicePost.emitterDelivery.emit(data);
            }, function (err) { return console.log("Erro"); });
        }
        this.HtmlEditor.reset();
        this.post = new __WEBPACK_IMPORTED_MODULE_1__shared_models_post__["a" /* Post */]('', '', '', this.autor, new Date());
    ...
    HtmleditorComponent.prototype.buildForm = function () {
        var _this = this;
        this.HtmlEditor = this.fb.group({
            'titulo': [this.post.titulo, [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* Validators */].minLength, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* Validators */].maxLength]],
            'resumo': [this.post.resumo, [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* Validators */].minLength, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* Validators */].maxLength]],
            'texto': [this.post.texto, [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* Validators */].minLength]],
            'autor': [this.post.autor, [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* Validators */].required]],
    ...
    HtmleditorComponent.prototype.onValueChanged = function (data) {
        if (!this.HtmlEditor) {
            return;
        }
        var form = this.HtmlEditor;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["U" /* Output */])(),
    __metadata("design:type", Object)
], HtmleditorComponent.prototype, "AvisaPai", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["F" /* Input */])(),
    __metadata("design:type", Object)
], HtmleditorComponent.prototype, "editarPost", void 0);
HtmleditorComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["o" /* Component */])({
        selector: 'htmleditor-component',
        template: __webpack_require__("../../../../../src/app/blog/htmleditor/htmleditor.component.html")
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormBuilder */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__shared_services_posts_ServicePost__["a" /* ServicePost */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__shared_services_posts_ServicePost__["a" /* ServicePost */]) === "function" && _b || Object])
], HtmleditorComponent);
...
var PostsComponent = (function () {
    function PostsComponent(router, servicoPost) {
        this.router = router;
        this.servicoPost = servicoPost;
        this.post = new __WEBPACK_IMPORTED_MODULE_1__shared_models_post__["a" /* Post */]('', '', '', '', new Date);
    }
    PostsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.inscricao = this.router.params.subscribe(function (data) { return _this.id = data['id']; }, function (err) { return console.log("erro"); });
        this.subpost = this.servicoPost.getPost(this.id).subscribe(function (data) { return _this.post = data; }, function (err) { return console.log('erro'); });
    };
...
PostsComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__shared_services_posts_ServicePost__["a" /* ServicePost */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__shared_services_posts_ServicePost__["a" /* ServicePost */]) === "function" && _b || Object])
], PostsComponent);
...
var Post = (function () {
    function Post(titulo, resumo, texto, autor, criada_em) {
        this.titulo = titulo;
        this.resumo = resumo;
        this.texto = texto;
        this.autor = autor;
...
/***/ "../../../../../src/app/shared/services/posts/ServicePost.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ServicePost; });
...
var ServicePost = (function () {
    ...
    ServicePost.prototype.jwt = function () {
        ...
        if (currentUser && currentUser.accessToken) {
            var headers = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Headers */]({ 'Authorization': 'Bearer ' + 'currentUser.accessToken ' });
            return new __WEBPACK_IMPORTED_MODULE_2__angular_http__["d" /* RequestOptions */]({ headers: headers });
        }
    };
    return ServicePost;
}());
ServicePost = __decorate([
...
var FroalaEditorDirective = (function () {
    function FroalaEditorDirective(el) {
        ...
        this.froalaModelChange = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* EventEmitter */]();
        // froalaInit directive as output: send manual editor initialization
        this.froalaInit = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* EventEmitter */]();
    ...
    FroalaEditorDirective.decorators = [
        { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* Directive */], args: [{
                    ...
                    providers: [{
                            provide: __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* NG_VALUE_ACCESSOR */], useExisting: Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_25" /* forwardRef */])(function () { return FroalaEditorDirective; }),
                            multi: true
                        }]
                },] },
    ];
    ...
    FroalaEditorDirective.propDecorators = {
        'froalaEditor': [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */] },],
        'froalaModel': [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */] },],
        'froalaModelChange': [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["U" /* Output */] },],
        'froalaInit': [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["U" /* Output */] },],
    };
...
var FroalaViewDirective = (function () {
    ...
    FroalaViewDirective.propDecorators = {
        'froalaView': [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */] },],
    };
